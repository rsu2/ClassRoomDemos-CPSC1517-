...
namespace WebApp.SamplePages
{
    public partial class BasicControls : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //The label MessageLabel is used to display message to the user
            ...
            //Determine if this is the first desplay of the page
            //  and if so, load data into the dropdownlist
            if (!Page.IsPostBack)
            {
                //Create an istance of List<T> for my "fake database" data 
                ...
                //.CompareTo() is a method that will compare to item and return the result
                //  of comparing two items. The results is interpreted by the Sort() to 
                ...
                //place th collection into the dropdownlist
        ...
        protected void SubmitButtonChoice_Click(object sender, EventArgs e)
        {
            ...
            //of other controls
            //controls have certain properties that can be accessed for obtaining
            ...
            else
            {
                ...
                //SelectedIndes returns the physical line index number
        ...
        {
            //when you have a pro,pt line in your dropdownlist, you should 
            //  test for it an do appropriate code to hanbdle the situation
