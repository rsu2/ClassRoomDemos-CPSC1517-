    ...
    public class ProductController
    {
        ...
        public int Products_Add(Product newproduct)
        {
            ...
            using (var context = new NorthwindContext())
            {
                ...
                //if this statement is executed BUT FAILS for some reason the insert is NOT completed (Rollback)
                //if this statement is executed AND is successful then the insert has physically placed the record on the database. 
                //      At this time you can retreive the new IDENTITY value
                context.SaveChanges();
